...
public function gallery(EntityManagerInterface $entityManager): Response
{
    ...
    #[Route('/dashboard/activities', name: 'app_activite_index', methods: ['GET'])]
    public function index(ActiviteRepository $ActiviteRepository,EntityManagerInterface $entityManager, Request $request): Response
    {
        $activites = $entityManager
            ...
            $activites = $sort === 'desc'
                ? $ActiviteRepository->findByIdDesc()
                : $ActiviteRepository->findByIdAsc();
