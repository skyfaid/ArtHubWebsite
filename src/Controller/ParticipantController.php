...
use App\Entity\ParticipantFormation;
...
class ParticipantController extends AbstractController
{
    ...
    public function index(EntityManagerInterface $entityManager): Response
    {
        $participants = $entityManager
            ->getRepository(ParticipantFormation::class)
            ->findAll();
    ...
    public function show(ParticipantFormation $participant): Response
    {
    ...
    public function edit(Request $request, ParticipantFormation $participant, EntityManagerInterface $entityManager): Response
    {
        $form = $this->createForm(ParticipantType::class, $participant);
        $form->handleRequest($request);
    ...
    public function delete(Request $request, ParticipantFormation $participant, EntityManagerInterface $entityManager): Response
    {
