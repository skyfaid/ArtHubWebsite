...
class QuizGeneratorService
{
    ...
    public function fetchQuizQuestion(string $topic = "general knowledge"): array
    {
        try {
            $response = $this->client->request('POST', 'https://api.openai.com/v1/chat/completions', [
                ...
                'json' => [
                    ...
                    'messages' => [
                        ['role' => 'user', 'content' => "Generate a quiz question about $topic with multiple choice answers."]
                    ]
                ]
            ]);
